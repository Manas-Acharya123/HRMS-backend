...
router.post("/check-in", auth, requireRole("OPERATOR"), async (req, res) => {
  try {
...
router.post("/check-out", auth, requireRole("OPERATOR"), async (req, res) => {
  try {
    const userId = req.user!.id;
...
router.get("/my-status", auth, requireRole("OPERATOR"), async (req, res) => {
  try {
    const userId = req.user!.id;
